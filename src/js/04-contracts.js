...
function renderDossierHtml(c){
  ...
  var enmRows=enms.length?enms.map(function(e,i){var t=e.tipo||'otro';var tc2=t==='ACTUALIZACION_TARIFAS'?'tar':t==='EXTENSION'?'ext':t==='SCOPE'?'scope':t==='CLAUSULAS'?'claus':'otro';return '<tr><td>'+(i+1)+'</td><td>'+_e(e.num)+'</td><td>'+_d(e.fecha)+'</td><td><span class="tag '+tc2+'">'+_e(t)+'</span></td><td>'+_e(e.descripcion||'\u2014')+'</td></tr>';}).join(''):'<tr><td colspan="5" class="empty-cell">Sin enmiendas registradas</td></tr>';
