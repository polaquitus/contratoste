...
(function(){
  ...
  var UsersAdmin = window.UsersAdmin = (function(){
    ...
    function buildModal(){
      ...
      function hideAllViews(){ ['vList','vForm','vDet','vMe2n','vMe2nDet','vIdx','vLicit','vProv','vUsersModule','vLegalesModule'].forEach(function(id){ var el=q(id); if(el) el.classList.remove('on'); }); document.querySelectorAll('.sb-nav .nv').forEach(function(n){ n.classList.remove('act'); }); }
